...
function mostrarDatos (){
    ...
    $titulos = [ "PRODUCTO_NO","DESCRIPCION","PRECIO_ACTUAL","STOCK_DISPONIBLE"];
    $msg = "<table>\n";
    ...
    foreach ($tpro as $pro) {
        ...
        $msg .="<td><a href=\"".$auto."?orden=Modificar&id=$pro->DESCRIPCION\">Modificar</a></td>\n";
        $msg .="<td><a href=\"".$auto."?orden=Detalles&id=$pro->DESCRIPCION\" >Detalles</a></td>\n";
        $msg .="</tr>\n";
